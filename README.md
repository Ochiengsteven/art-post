...
**art-post app** is a project where user can create posts, add comments to the post as well, likes for their Artworks.
...
1. Clone this repository to your desired folder:
   ...
   ```sh
   git clone https://github.com/Ochiengsteven/art-post.git
...
[issues page](https://github.com/Ochiengsteven/art-post/issues).
...
This project is [MIT](https://github.com/Ochiengsteven/art-post/blob/create-models/LICENSE.md) licensed.